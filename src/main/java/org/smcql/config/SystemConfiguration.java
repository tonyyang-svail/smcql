...
public class SystemConfiguration {
  ...
  protected SystemConfiguration() throws Exception {
    ...
    if (configFile == null) configFile = Utilities.getSMCQLRoot() + "/conf/setup";
  ...
  void initializeCalcite() throws ClassNotFoundException, SQLException {
    ...
    calciteConfig =
        Frameworks.newConfigBuilder().defaultSchema(pdnSchema).parserConfig(parserConf).build();
  }
